...
#define socketStart {
    ...
    MyConnection *socket = new MyConnection();
...
#define connectSignalSlotStart {
    ...
    QObject::connect(buttonConnect, &QPushButton::clicked, [=]{ socket->startConnection(ipLineEdit, portLineEdit); });
